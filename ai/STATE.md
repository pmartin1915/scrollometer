...
- **WP7+WP8 in flight** (spec `.orchestrate/spec-wp78.md`, worktree `.orchestrate/wt/wp78`): Today dashboard + History (Swift Charts) + Methodology view + weekly recap + ImageRenderer share cards (1080×1920/1080×1080) + real widget timeline. Medium review; sealed-days rule and share-card sizing are the focus.
